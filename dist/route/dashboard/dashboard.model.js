...
export const dashboardGetModel = async () => {
    ...
    const [totalActivatedPackage, numberOfRegisteredUser, totalActivatedUser, totalPendingWithdrawal,] = await prisma.$transaction([
    ...
    const response = {
        ...
        totalActivatedUser,
        totalWithdrawalForTomorrow: totalPendingWithdrawal._sum.company_withdrawal_request_withdraw_amount ??
            0,
    };
